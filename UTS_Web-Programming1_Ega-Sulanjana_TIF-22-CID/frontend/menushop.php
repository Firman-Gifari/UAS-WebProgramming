...
<section>
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
    <header>
      <h2 class="text-xl font-bold text-gray-900 sm:text-3xl">Semua Produk</h2>
    </header>
        ...
        <div class="relative">
          <details class="group [&_summary::-webkit-details-marker]:hidden">
            ...
            >
              <div class="w-96 rounded border border-gray-200 bg-white">
                <header class="flex items-center justify-between p-4">
                  <span class="text-sm text-gray-700"> The highest price is IDR 199.000 </span>
                ...
                <div class="border-t border-gray-200 p-4">
                  <div class="flex justify-between gap-4">
                    <label for="FilterPriceFrom" class="flex items-center gap-2">
                      <span class="text-sm text-gray-600">IDR</span>
    ...
    <div class="mt-8 flex flex-wrap justify-center gap-4 items-center">
      ...
      <a
        href="#"
        class="inline-flex items-center justify-center rounded border border-gray-100 bg-white text-gray-900 rtl:rotate-180 p-2"
      >
    ...
    <div class="mt-8 flex justify-center">
      <a
        ...
        class="block w-full rounded bg-gray-600 px-12 py-3 text-sm font-medium text-white shadow hover:bg-gray-700 focus:outline-none focus:ring active:bg-gray-800 sm:w-auto"
      >
        Kembali ke beranda
      </a>
    </div>
  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    ...
    <div class="mt-16 border-t border-gray-100 pt-8">
      <p class="text-center text-xs/relaxed text-gray-500">
        @Copyright by 22552011171_EGA-SULANJANA_TIF-22-CID_UASWEB1.
      </p>
    </div>
  </div>
</footer>
