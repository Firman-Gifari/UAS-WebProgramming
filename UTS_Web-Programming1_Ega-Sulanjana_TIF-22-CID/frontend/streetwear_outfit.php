...
$products = $database_connection->query("
  SELECT * 
  FROM products 
  WHERE category = 'Streetwear Outfit'
")->fetchAll();
?>
      ...
      <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        ...
        <a class="w-0" href="landingpage.php"
          ...
          <p class="mt-4 max-w-md text-gray-500">
            Berikut adalah kumpulan produk kami bertemakan streetwear yang
            populer dan best seller, jangan lupa untuk menghabiskan uang anda
            disini yaa, keep enjoy of the shopping
          </p>
        </header>
